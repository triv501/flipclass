...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="index.php">Asignaturas <span class="glyphicon glyphicon-menu-down"></span></a>
                    </li>
                    <li>
  ...
  ?> 
        ...
        <!-- Page Heading -->
            ...
            <div id="inferior">
            <form enctype="multipart/form-data" action="../php/uploader.php?a=<?php echo $_GET['b'] ?>&b=<?php echo $_GET['a'] ?>" method="POST">
				<input name="uploadedfile" class="btn btn-info btn-lg" type="file" /><br>
				<input type="submit" class="btn btn-info btn-lg" value="Agregar documento">
			</form>
       </div>
